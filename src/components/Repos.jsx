...
const Repos = () => {
  ...
  //
  //obejct.value give value of object in arrays
  const mostUsed=Object.values(languages).sort((a,b)=>{
    return b.value-a.value
  }).slice(0,5) /// for Most popular language by sorting
  //slice is used to get most 5 popular language used so that show only that
